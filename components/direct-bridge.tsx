...
import { CHAINS, isConnectedToOptimism, switchToOptimism, bridgeETH } from "@/services/fixed-layerzero-service"

export default function DirectBridge() {
      ...
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="p-3 bg-gray-700 rounded">
            <p className="text-sm font-medium">Fixed Test Parameters:</p>
            <p className="text-sm">• Amount: 0.0001 ETH</p>
            <p className="text-sm">• Fee: 0.0003 ETH</p>
            <p className="text-sm">• Total: 0.0004 ETH</p>
            <p className="text-xs text-gray-400 mt-1">
              For safety, we're using a minimal test amount with fixed parameters
            </p>
          </div>
